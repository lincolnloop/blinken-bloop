...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'events_event', 'timezone',
                      self.gf('django.db.models.fields.CharField')(default='America/Los_Angeles', max_length=63),
                      keep_default=False)
    ...
    models = {
        ...
        u'events.event': {
            ...
            'shortid': ('django.db.models.fields.CharField', [], {'max_length': '10', 'blank': 'True'}),
            'start': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'timezone': ('django.db.models.fields.CharField', [], {'default': "'America/Los_Angeles'", 'max_length': '63'}),
        ...
        u'events.rsvp': {
            ...
            'response': ('django.db.models.fields.CharField', [], {'default': "'yes'", 'max_length': '10'}),
